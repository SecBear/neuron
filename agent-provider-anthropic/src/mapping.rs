//! Request/response mapping between agent-types and the Anthropic Messages API format.
//!
...
/// Map a [`agent_types::CacheControl`] to Anthropic's cache_control object.
fn map_cache_control(cc: &agent_types::CacheControl) -> serde_json::Value {
