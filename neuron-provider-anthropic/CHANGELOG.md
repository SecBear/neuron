...
All notable changes to `neuron-provider-anthropic` are documented here.
Maintained by [release-please](https://github.com/googleapis/release-please)
from [Conventional Commits](https://www.conventionalcommits.org/).

## [0.4.0](https://github.com/SecBear/neuron/compare/neuron-provider-anthropic-v0.3.0...neuron-provider-anthropic-v0.4.0) (2026-02-24)
