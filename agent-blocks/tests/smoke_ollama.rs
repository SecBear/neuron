...
//!
//!     cargo test -p agent-blocks --features ollama --test smoke_ollama -- --ignored
//!
...
fn ollama() -> agent_blocks::ollama::Ollama {
    agent_blocks::ollama::Ollama::new()
        .model("llama3.2")
