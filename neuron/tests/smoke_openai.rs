...
//!
//!     OPENAI_API_KEY=sk-... cargo test -p neuron --features openai --test smoke_openai -- --ignored
//!
...
fn openai() -> neuron::openai::OpenAi {
    neuron::openai::OpenAi::new(api_key()).model("gpt-4o-mini")
}
